...
public final class GuiSelectIdioma {
    ...
    public ResourceBundle UserChoice() {
        ...
        choice = switch (this.idioma) {
            ...
            case "Espanhol" ->
                ResourceBundle.getBundle("messages", new Locale("es", "ES"));
            case "Francês" ->
                ResourceBundle.getBundle("messages", new Locale("fr", "FR"));
            case "Italiano" ->
                ResourceBundle.getBundle("messages", new Locale("it", "IT"));
            default ->
