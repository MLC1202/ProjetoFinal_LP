...
public class ChatClient {
    ...
    public ChatClient(String host, int port, String username, ResourceBundle idioma) throws IOException {
        this.host = host;
        this.port = port;
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                if (users.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(
                            parent,
                            idioma.getString("chat.client.noclientonline"),
                            idioma.getString("chat.client.usersonline"),
                            JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(
                            parent,
                            idioma.getString("chat.client.usersonlineshow") + "\n" + users,
                            idioma.getString("chat.client.usersonline"),
                            JOptionPane.INFORMATION_MESSAGE);
                }
            });
    ...
    public void openChatWindow() {
        ...
        SwingUtilities.invokeLater(() -> {
            chatFrame = new JFrame(idioma.getString("chat.client.title") + " - " + username);
